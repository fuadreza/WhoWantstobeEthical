...
import io.github.fuadreza.whowantstobeethical.ukur.UkurActivity;

/**
 * Dibuat dengan kerjakerasbagaiquda oleh Shifu pada tanggal 24/08/2018.
 */
public class Teonom2Fragment extends Fragment implements View.OnClickListener, SeekBar.OnSeekBarChangeListener {

    private Intent pindah;
    private DataSkor ds;

    public Teonom2Fragment() {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        tvSoal.setText(R.string.soal_teonom_2);
        ...
        ds.setTeonom_2(sbJawaban.getProgress());
        tvMin.setText(R.string.min_teonom_2);
        tvMax.setText(R.string.max_teonom_2);
    ...
    public void onClick(View view) {
        if (view.getId() == R.id.btn_next) {
            if (pindah == null) {
                pindah = new Intent(this.getContext(), UkurActivity.class);
            }
    ...
    public void onStopTrackingTouch(SeekBar seekBar) {
        ds.setTeonom_2(seekBar.getProgress());
