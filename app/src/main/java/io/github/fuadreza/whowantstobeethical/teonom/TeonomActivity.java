 ...
 */
public class TeonomActivity extends AppCompatActivity {

    private TeonomFragmentPagerAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvDesc.setText(R.string.teonom_des);

        //Edit gambar
        ImageView iv = findViewById(R.id.image_1);
        DrawableImageViewTarget imageViewTarget = new DrawableImageViewTarget(iv);
        Glide.with(this).load(R.raw.caring).into(imageViewTarget);
        ...
        if (adapter == null) {
            adapter = new TeonomFragmentPagerAdapter(this, getSupportFragmentManager());
        }
