 ...
 */
public class Right2Fragment extends Fragment implements SeekBar.OnSeekBarChangeListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        tvSoal.setText(R.string.soal_right_2);
        ...
        ds.setRight_2(sbJawaban.getProgress());
        tvMin.setText(R.string.min_right_2);
        tvMax.setText(R.string.max_right_2);
    ...
    public void onStopTrackingTouch(SeekBar seekBar) {
        ds.setRight_2(seekBar.getProgress());
