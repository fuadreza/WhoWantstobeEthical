 ...
 */
public class Deontologi1Fragment extends Fragment implements SeekBar.OnSeekBarChangeListener {

    private DataSkor ds;

    public Deontologi1Fragment() {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        tvSoal.setText(R.string.soal_deon_1);
        ...
        ds.setDeon_1(sbJawaban.getProgress());
    ...
    public void onStopTrackingTouch(SeekBar seekBar) {
        ds.setDeon_1(seekBar.getProgress());
