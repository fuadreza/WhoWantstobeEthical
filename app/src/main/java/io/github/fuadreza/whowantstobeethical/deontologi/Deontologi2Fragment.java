package io.github.fuadreza.whowantstobeethical.deontologi;
...
import io.github.fuadreza.whowantstobeethical.right.RightActivity;

/**
 * Dibuat dengan kerjakerasbagaiquda oleh Shifu pada tanggal 24/08/2018.
 */
public class Deontologi2Fragment extends Fragment implements View.OnClickListener, SeekBar.OnSeekBarChangeListener {

    private Intent pindah;
    private DataSkor ds;

    public Deontologi2Fragment() {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        tvSoal.setText(R.string.soal_deon_2);
        ...
        ds.setDeon_2(sbJawaban.getProgress());
        tvMin.setText(R.string.min_deon_1);
        tvMax.setText(R.string.max_deon_1);
    ...
    public void onClick(View view) {
        if (view.getId() == R.id.btn_next) {
            if (pindah == null) {
                pindah = new Intent(this.getContext(), RightActivity.class);
            }
    ...
    public void onStopTrackingTouch(SeekBar seekBar) {
        ds.setDeon_2(seekBar.getProgress());
