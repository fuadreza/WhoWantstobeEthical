 ...
 */
public class Right1Fragment extends Fragment implements SeekBar.OnSeekBarChangeListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        tvSoal.setText(R.string.soal_right_1);
        ...
        ds.setRight_1(sbJawaban.getProgress());
        tvMin.setText(R.string.min_right_1);
        tvMax.setText(R.string.max_right_1);
    ...
    public void onStopTrackingTouch(SeekBar seekBar) {
        ds.setRight_1(seekBar.getProgress());
