 ...
 */
public class Virtue1Fragment extends Fragment implements SeekBar.OnSeekBarChangeListener {

    private DataSkor ds;

    public Virtue1Fragment() {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        tvSoal.setText(R.string.soal_virtue_1);
        ...
        ds.setVirtue_1(sbJawaban.getProgress());
        tvMin.setText(R.string.min_virtue_1);
        tvMax.setText(R.string.max_virtue_1);
    ...
    public void onStopTrackingTouch(SeekBar seekBar) {
        ds.setVirtue_1(seekBar.getProgress());
